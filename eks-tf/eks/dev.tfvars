...
ondemand_instance_types    = ["m7i-flex.large"] # doing it just because of limitation due to free tier aws 
spot_instance_types        = ["m7i-flex.large"] # doing it just because of limitation due to free tier aws 
